        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {/* WhatsApp Support */}
              <a 
                href="https://wa.me/+2348139113344"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gradient-to-r from-green-400 to-green-500 rounded-lg p-3 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer group block"
              >
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-gradient-to-r from-blue-400 to-blue-500 rounded-lg p-3 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer group block"
              >
                <div className="flex items-center justify-center">
                  <div className="text-white mr-2">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-white font-semibold text-center text-xs">
                    Join our WhatsApp channel for News and give away
                  </span>
                </div>
              </a>
            </div>
